...
/**
 * Given a binary tree,
 * convert it to a doubly linked list so that the order of the doubly linked list
 * is the same as an in-order traversal of the binary tree.
 */
public class BTree2DoubleLinkedList {
    ...
    public static boolean test1() {
        ...
        boolean output = (result != null && result.get(result.size() - 1) == 200);
        System.out.println("Test1 result " + output);
        return output;
    }
